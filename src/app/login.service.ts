...
export class LoginService {
  ...
  public getCampaignDetailsFromRemote():Observable<any>{
    return this._http.get("http://ec2-3-135-228-77.us-east-2.compute.amazonaws.com:8080/listCampain");
  }
...
return this._http.post("http://ec2-3-135-228-77.us-east-2.compute.amazonaws.com:8080/addCampain",campaign);
  }
  public addUserFromRemote(user : User):Observable<any>{
    return this._http.post("http://ec2-3-135-228-77.us-east-2.compute.amazonaws.com:8080/signup",user);
  }
}
